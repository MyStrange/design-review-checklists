                            ...
                            "properties": {
                                ...
                                "items": {
                                    ...
                                    "items": {
                                        ...
                                        "properties": {
                                            "text": {"type": "STRING"},
                                            "tag": {"type": "STRING", "enum": ["ux", "dev", "discuss"]},
                                        },
                                        "required": ["text", "tag"],
                                    },
                                },
...
Для каждого пункта проставь тег категории (поле tag):
- "ux" — правка по дизайну/интерфейсу/UX (большинство правок);
- "dev" — задача на разработку или техническую реализацию;
- "discuss" — нужно уточнить, согласовать, обсудить, дождаться чьего-то ответа.
Если сомневаешься — ставь "ux".
